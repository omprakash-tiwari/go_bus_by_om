  ...
  <footer id="footer">
    <div class="container">
      ...
      <div class="credits">
        ...
        Designed by <a href="profile.php">Bus Transport</a>
      </div>
    </div>
  </footer><!-- #footer -->
  ...
  <script>
   $(document).on('click', '.cancel-ticket', function (e) {
       ...
       if (confirm('Are you sure you want to cancel this ticket?')) {
           $.ajax({
               url: 'action.php', // Ensure this is the correct path to your action.php
               type: 'POST',
               data: { cancel_ticket: true, ticket_id: ticketId },
               success: function (response) {
                   alert(response);
                   location.reload(); // Reload the page to update the ticket list
               },
               error: function () {
