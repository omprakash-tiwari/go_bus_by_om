...
<body id="body">
  ...
  <section id="topbar" class="d-none d-lg-block">
    <div class="container clearfix">
      <div class="contact-info float-left">
        ...
        <i class="fa fa-phone"></i> +91 6352624117
      </div>
    </div>
  </section>
  ...
  <section id="intro">
    ...
    <div class="intro-content">
      <h2><span>Your Ride,</span> Our<br> Priority!</h2>
      <div>
    ...
    <section id="portfolio" class="wow fadeInUp">
      <div class="container">
        <div class="section-header">
          <h2>Our Portfolio</h2>
          <p>"The Desire to Explore is a Sign of a Life Well-Lived." </p>
        </div>
      </div>
     ...
     <section id="Partners" class="wow fadeInUp">
      <div class="container">
        <div class="section-header">
          <h2>Partners</h2>
          <p>"Together with Our Partners, We Create Travel Experiences That Delight and Inspire."</p>
        </div>
